...
abstract class BasePetitionTextForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'privacy_policy_link_text'     => new sfWidgetFormTextarea(),
      ...
      'label_extra2'                 => new sfWidgetFormInputText(),
      'placeholder_extra2'           => new sfWidgetFormInputText(),
      'label_extra3'                 => new sfWidgetFormInputText(),
      'placeholder_extra3'           => new sfWidgetFormInputText(),
      'form_title'                   => new sfWidgetFormInputText(),
      'subscribe_text'               => new sfWidgetFormInputText(),
      'tyf_title'                    => new sfWidgetFormInputText(),
      'additional_link_url'          => new sfWidgetFormInputText(),
      'additional_link_label'        => new sfWidgetFormInputText(),
      'signers_page'                 => new sfWidgetFormTextarea(),
      'digest_subject'               => new sfWidgetFormTextarea(),
      'digest_body_intro'            => new sfWidgetFormTextarea(),
      'digest_body_outro'            => new sfWidgetFormTextarea(),
    ...
    $this->setValidators(array(
      ...
      'privacy_policy_link_text'     => new sfValidatorString(array('required' => false)),
      ...
      'label_extra2'                 => new sfValidatorString(array('max_length' => 80, 'required' => false)),
      'placeholder_extra2'           => new sfValidatorString(array('max_length' => 80, 'required' => false)),
      'label_extra3'                 => new sfValidatorString(array('max_length' => 80, 'required' => false)),
      'placeholder_extra3'           => new sfValidatorString(array('max_length' => 80, 'required' => false)),
      ...
      'tyf_title'                    => new sfValidatorString(array('max_length' => 100, 'required' => false)),
      'additional_link_url'          => new sfValidatorString(array('max_length' => 200, 'required' => false)),
      'additional_link_label'        => new sfValidatorString(array('max_length' => 200, 'required' => false)),
      'signers_page'                 => new sfValidatorString(array('required' => false)),
      'digest_subject'               => new sfValidatorString(array('required' => false)),
      'digest_body_intro'            => new sfValidatorString(array('required' => false)),
      'digest_body_outro'            => new sfValidatorString(array('required' => false)),
