...
abstract class BaseWidgetForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'show_counter'             => new sfWidgetFormInputText(),
      'show_embed_this'          => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'show_counter'             => new sfValidatorString(array('max_length' => 15, 'required' => false)),
      'show_embed_this'          => new sfValidatorInteger(array('required' => false)),
