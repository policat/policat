...
//  }
  ...
  public function executePricing(sfWebRequest $request) {
    ...
    $table = '<table class="table table-responsive-md table-bordered" style="width:auto"><tr><th>Package</th><th>E-mails / participants</th><th>Days</th><th>Net</th><th>Gross</th></tr>';
