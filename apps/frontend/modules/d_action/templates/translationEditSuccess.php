...
<form class="ajax_form form-horizontal<?php if ($form->getObject()->isNew()): ?> change_onload<?php endif ?>" action="<?php echo $form->getObject()->isNew() ? url_for('translation_create', array('id' => $petition->getId())) : url_for('translation_edit', array('id' => $translation->getId())) ?>" method="post">
    <fieldset>
        ...
        <?php echo $form->renderRows(array('*label_extra1', '*placeholder_extra1', '*label_extra2', '*placeholder_extra2', '*label_extra3', '*placeholder_extra3', '*subscribe_text', '*tyf_title', '*social_share_text', '*additional_link_url', '*additional_link_label')) ?>
        ...
        <?php echo $form->renderRows(array('privacy_policy_link_text', 'privacy_policy_url', 'privacy_policy_body')) ?>
    ...
    <div class="form-actions">
        ...
        <a class="btn btn-secondary submit" data-submit='{"go_widget":1}'>Save &amp; and create new widget from this translation</a>
        <a class="btn btn-secondary" href="<?php echo url_for('petition_translations', array('id' => $petition->getId())) ?>">Cancel</a>
    </div>
</form>
